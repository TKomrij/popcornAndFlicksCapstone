...
export const MovieProvider = (props) => {
    ...
    return (
        <MovieContext.Provider value={{
            movies, getMovies, setMovies, getMovieById, getFavoriteMovies, favoriteMovie, unfavoriteMovie,  getWatchLaterMovies, watchLaterMovie, deleteWatchLaterMovie, favoriteButtonClicked, isFavoritedMovie, watchLaterButtonClicked, isWatchLaterMovie
        }}>
            {props.children}
